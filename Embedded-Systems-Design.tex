...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, left=2mm]
