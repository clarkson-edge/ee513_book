...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, bottomrule=.15mm, colback=white, breakable, opacityback=0, toprule=.15mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, arc=.35mm]
