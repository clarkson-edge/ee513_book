...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, left=2mm, colframe=quarto-callout-note-color-frame, opacityback=0, arc=.35mm, colback=white, leftrule=.75mm, breakable, bottomrule=.15mm, toprule=.15mm]
