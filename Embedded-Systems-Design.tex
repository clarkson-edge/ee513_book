...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, bottomrule=.15mm, left=2mm, colback=white, leftrule=.75mm, rightrule=.15mm, toprule=.15mm]
